...
{
    private static readonly ConditionalWeakTable<Body, BodyStatusCollection> BodyStatuses = new();

    private static readonly ConditionalWeakTable<Limb, LimbStatusCollection> LimbStatuses = new();
    ...
    {
        private readonly Dictionary<Type, BodyStatus> _entries = new();
    ...
    {
        private readonly Dictionary<Type, LimbStatus> _entries = new();
    ...
    {
        private static readonly Dictionary<Type, StatusMetadata> ByType = new();

        private static readonly Dictionary<string, StatusMetadata> ByKey = new(StringComparer.Ordinal);
