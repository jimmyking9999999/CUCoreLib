...
{
    internal static Dictionary<string, CustomItemInfo> RegisteredItems = new(StringComparer.OrdinalIgnoreCase);

    private static readonly Dictionary<string, string> ItemOwners = new(StringComparer.OrdinalIgnoreCase);
