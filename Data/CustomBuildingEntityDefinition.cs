...
namespace CUCoreLib.Data
{
    ...
    public sealed class CustomBuildingEntityDefinition
    {
        ...
        ///     Defaults the instance to the vanilla crate Ground layer unless <see cref="Layer" /> or <see cref="LayerEnum" /> is
        ///     set.
        /// </summary>
        public bool AddRigidbody2D;

        /// <summary>
        ///     Drops always spawned when the entity is destroyed, regardless of chance-based drop logic. Added to match game
        ///     internal behaviour, but not really needed. Just set a drop chance to 1f.
        /// </summary>
        ...
        /// <summary>
        ///     Additional component types attached to the spawned prefab. Yay custom behavior! (Use <see cref="SpawnComponents" />
        ///     for string-based component registration)
        /// </summary>
        ...
        /// <summary>
        ///     Makes an added <c>Rigidbody2D</c> damage player limbs on sufficiently fast impacts, using vanilla stalactite
        ///     behavior.
        /// </summary>
        ...
        /// <summary>
        ///     Reference building id used to copy a vanilla hit sound when <see cref="HitSound" /> is not set. Default 'rustle'
        ///     (glowplant)
        /// </summary>
        ...
        /// <summary>
        ///     Offset from the placement surface to the rendered object. For ground, goes up. For ceiling, goes down. For walls,
        ///     goes out from the wall.
        /// </summary>
