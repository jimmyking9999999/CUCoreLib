...
namespace CUCoreLib.Data
{
    ...
    public class CustomLiquidInfo
    {
        ...
        /// <summary>
        ///     Reuses locale text from an item registration instead of registering separate liquid locale entries. Don't set this
        ///     to true if the liquid is not associated with an item.
        /// </summary>
