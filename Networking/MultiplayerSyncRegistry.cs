...
public static class MultiplayerSyncRegistry
{
    ...
    private static readonly Dictionary<string, Func<JObject>> CaptureModules = new(StringComparer.Ordinal);

    private static readonly Dictionary<string, Action<JObject>> ApplyModules = new(StringComparer.Ordinal);
