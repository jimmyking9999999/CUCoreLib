...
public sealed class ContentReloadResult
{
    ...
    private readonly List<string> recognizedMethods = new();
...
internal sealed class ContentReloadConfig
{
    ...
    public Dictionary<string, ContentReloadModConfig> Mods { get; set; } = new(StringComparer.OrdinalIgnoreCase);
}
...
internal sealed class ContentCompatibilityReport
{
    ...
    public List<string> RecognizedMethods { get; } = new();
...
internal sealed class ContentReloadState
{
    ...
    public Dictionary<string, ContentObservedFileState> ObservedFiles { get; } = new(StringComparer.OrdinalIgnoreCase);
}